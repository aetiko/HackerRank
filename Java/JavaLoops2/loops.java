...
// Using a multiplier (multiplier *= 2) is slightly faster than Math.pow(2, j),
// since:
// Math.pow() uses floating-point operations, while multiplier *= 2 just doubles
// an integer.
// Floating-point operations can be slower and less precise for large values.
// If performance matters, go with the multiplier approach. Otherwise,
// Math.pow(2, j) is fine for readability.